...
export const RouanetSection: React.FC<RouanetSectionProps> = ({ leisIncentivo, isLoading }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {isLoading && (
          <div className="bg-white rounded-2xl border border-blue-200 p-8 text-center space-y-3">
            <RefreshCw className="w-8 h-8 text-blue-600 animate-spin mx-auto" />
            <p className="text-xs text-slate-600 font-semibold">Consultando base oficial da Lei Rouanet / SalicNet...</p>
          </div>
        )}
